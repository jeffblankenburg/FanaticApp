...
namespace FanaticWP8
{
    public partial class App : Application
    {
        ...
        public static List<Team> NBA = new List<Team> { 
                                          new Team { League = "NBA", Abbreviation = "ATL", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Atlanta", Mascot = "Hawks" },
                                          new Team { League = "NBA", Abbreviation = "BKN", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Brooklyn", Mascot = "Nets" },
                                          new Team { League = "NBA", Abbreviation = "BOS", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Boston", Mascot = "Celtics" },
                                          new Team { League = "NBA", Abbreviation = "CHA", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Charlotte", Mascot = "Bobcats" },
                                          new Team { League = "NBA", Abbreviation = "CHI", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Chicago", Mascot = "Bulls" },
                                          new Team { League = "NBA", Abbreviation = "CLE", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Cleveland", Mascot = "Cavaliers" },
                                          new Team { League = "NBA", Abbreviation = "DAL", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Dallas", Mascot = "Mavericks" },
                                          new Team { League = "NBA", Abbreviation = "DEN", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Denver", Mascot = "Nuggets" },
                                          new Team { League = "NBA", Abbreviation = "DET", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Detroit", Mascot = "Pistons" },
                                          new Team { League = "NBA", Abbreviation = "GS",  PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Golden State", Mascot = "Warriors" },
                                          new Team { League = "NBA", Abbreviation = "HOU", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Houston", Mascot = "Rockets" },
                                          new Team { League = "NBA", Abbreviation = "IND", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Indiana", Mascot = "Pacers" },
                                          new Team { League = "NBA", Abbreviation = "LAC", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Los Angeles", Mascot = "Clippers" },
                                          new Team { League = "NBA", Abbreviation = "LAL", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Los Angeles", Mascot = "Lakers" },
                                          new Team { League = "NBA", Abbreviation = "MEM", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Memphis", Mascot = "Grizzlies" },
                                          new Team { League = "NBA", Abbreviation = "MIA", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Miami", Mascot = "Heat" },
                                          new Team { League = "NBA", Abbreviation = "MIL", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Milwaukee", Mascot = "Bucks" },
                                          new Team { League = "NBA", Abbreviation = "MIN", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Minnesota", Mascot = "Timberwolves" },
                                          new Team { League = "NBA", Abbreviation = "NO",  PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "New Orleans", Mascot = "Pelicans" },
                                          new Team { League = "NBA", Abbreviation = "NYK", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "New York", Mascot = "Knicks" },
                                          new Team { League = "NBA", Abbreviation = "OKC", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Oklahoma City", Mascot = "Thunder" },
                                          new Team { League = "NBA", Abbreviation = "ORL", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Orlando", Mascot = "Magic" },
                                          new Team { League = "NBA", Abbreviation = "PHI", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Philadelphia", Mascot = "76ers" },
                                          new Team { League = "NBA", Abbreviation = "PHX", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Phoenix", Mascot = "Suns" },
                                          new Team { League = "NBA", Abbreviation = "POR", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Portland", Mascot = "Trailblazers" },
                                          new Team { League = "NBA", Abbreviation = "SA",  PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "San Antonio", Mascot = "Spurs" },
                                          new Team { League = "NBA", Abbreviation = "SAC", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Sacramento", Mascot = "Kings" },
                                          new Team { League = "NBA", Abbreviation = "TOR", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Toronto", Mascot = "Raptors" },
                                          new Team { League = "NBA", Abbreviation = "UTAH",PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Utah", Mascot = "Jazz" },
                                          new Team { League = "NBA", Abbreviation = "WAS", PrimaryColor = "", SecondaryColor = "", TertiaryColor = "", City = "Washington", Mascot = "Wizards" }};
